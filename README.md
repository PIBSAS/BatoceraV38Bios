...
```
curl -sSL https://raw.githubusercontent.com/PIBSAS/BatoceraV38Bios/main/pi.sh | bash
```
...
```
curl -sSL https://raw.githubusercontent.com/PIBSAS/BatoceraV38Bios/main/pc.sh | bash
```
### Enjoy!!! --- A disfrutar!!!
